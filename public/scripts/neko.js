...
(function() {
  ...
  class Neko {
    ...
    init() {
      ...
      // Pre set the starting position within viewport
      this.x = 0.35 * this.boundsWidth;
      this.y = 0.032 * this.boundsHeight;
      this.logicX = this.x;
      this.logicY = this.y;
      this.prevLogicX = this.x;
      this.prevLogicY = this.y;
...
function getTextObstacles(root = document.body) {
